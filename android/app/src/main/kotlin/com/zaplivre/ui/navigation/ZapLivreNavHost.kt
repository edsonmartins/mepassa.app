package com.zaplivre.ui.navigation
...
import com.zaplivre.ui.screens.call.CallScreen
import com.zaplivre.ui.screens.call.IncomingCallScreen
import com.zaplivre.ui.screens.call.VideoCallScreen
import com.zaplivre.ui.screens.chat.ChatScreen
import com.zaplivre.ui.screens.conversations.ConversationsScreen
import com.zaplivre.ui.screens.group.GroupChatScreen
import com.zaplivre.ui.screens.group.GroupInfoScreen
import com.zaplivre.ui.screens.group.GroupListScreen
import com.zaplivre.ui.screens.onboarding.OnboardingScreen
import com.zaplivre.ui.utils.getPermissionDeniedMessage
import com.zaplivre.ui.utils.rememberVoipPermissions
...
fun ZapLivreNavHost(
    ...
    val incomingCall by ZapLivreClientWrapper.incomingCall.collectAsState()
    LaunchedEffect(incomingCall) {
        ...
        ZapLivreClientWrapper.consumeIncomingCall()
    }
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable(
            ...
            val voipPermissions = rememberVoipPermissions(
                onPermissionsGranted = {
                    ...
                    scope.launch {
                        val result = ZapLivreClientWrapper.startCall(peerId)
        ...
        composable(Screen.Settings.route) {
            com.zaplivre.ui.screens.settings.SettingsScreen(
        ...
        composable(Screen.Profile.route) {
            com.zaplivre.ui.screens.profile.ProfileScreen(
                onNavigateBack = { navController.popBackStack() },
        ...
        composable(Screen.Search.route) {
            com.zaplivre.ui.screens.search.MessageSearchScreen(
                onBack = { navController.popBackStack() },
                onMessageClick = { message ->
                    val peer = if (message.senderPeerId == ZapLivreClientWrapper.localPeerId.value) {
        ...
        composable(
            ...
            val peerId = backStackEntry.arguments?.getString("peerId") ?: return@composable
            com.zaplivre.ui.screens.media.MediaGalleryScreen(
        ...
        composable(
            ...
            var mediaItems by androidx.compose.runtime.remember {
                androidx.compose.runtime.mutableStateOf<List<uniffi.zaplivre.FfiMedia>>(emptyList())
            }
            androidx.compose.runtime.LaunchedEffect(peerId) {
                mediaItems = ZapLivreClientWrapper.getConversationMedia("1:1:$peerId")
            }
